...
public class Track extends MusicItem {
    ...
    public Track( final Artist artist, final Album album, final int id, final String name, final String path,
            final int number, final Date dateAdded ) {
        this(artist, album, id, name, path, number, dateAdded, null);
    }
    ...
    /**
     * returns the sql to use to select the right information for creating a new
     * track object
     *
     * @return the sql
     */
     ...
     */
    private static String getPlaylistSql( final String type, final int id, final String orderBySql )
            throws BadRequestException {
     ...
     * @throws BadRequestException
     */
    public static List<Track> getTracks( final Database db, final String type, final int id ) throws SQLException,
            BadRequestException {
        return getTracks(db, type, id, "");
    }

    public static List<Track> getTracks( final Database db, final String type, final int id, final String orderBySql )
    ...
    /**
     * returns a list of track objects that are loaded from an array of custom
     * url arguments of the form "tr123/al456/ar789"
     *
     * @param db the database connection
     ...
     * @throws BadRequestException
     */
    public static List<Track> getTracksFromPlayArgs( final Database db, final String[] args ) throws SQLException,
            BadRequestException {
        return getTracksFromPlayArgs(db, args, "");
    }

    public static List<Track> getTracksFromPlayArgs( final Database db, final String[] args, final String orderBySql )
            throws SQLException, BadRequestException {
    ...
    public static List<Track> getTracksFromPath( final Database db, final String path ) throws SQLException {
        ...
        try {
            ...
            final String sql = getSelectFromSql() + " where t.path like ? " + " order by t.path asc ";
    ...
    public static Track find( final Database db, final int id ) throws SQLException {
        ...
        try {
            ...
            final String sql = getSelectFromSql() + " where t.id = ? ";
     ...
     * @throws SQLException
     */
    public static List<Track> findAll( final Database db, final int limit, final int offset, final long fromDate )
            throws SQLException {
