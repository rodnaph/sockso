...
{include file="include/header.tpl" title="Customizing Sockso!"}
...
<p>Sockso uses {link url={ action="skins" } text="skins" } to display different designs
...
their <b>htdocs/skins</b> folder and switch their {link url={ action="skins" } text="skin"}
...
going to need to start hacking the code.  Get over to the {link url={ controller="source" } text="source code"}
