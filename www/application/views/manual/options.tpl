...
{include file="include/header.tpl" title="Sockso Options"}
...
<p><a href="{$smutty->baseUrl}/images/manual/options-1.png"><img
    src="{$smutty->baseUrl}/images/manual/options-1-small.png" /></a></p>
