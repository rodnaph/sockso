...
{include file="include/header.tpl" title="Command Line Options"}
...
requires the {link url={ action="optionals" } text="optionals package"}.</p>
...
{link url={ action="optionals" } text="optionals installed"}.
</p>
