...
{include file="include/header.tpl" title="Playing Music"}
...
<p><img src="{$smutty->baseUrl}/images/manual/playing-1.png" /></p>
...
<b>But</b> you can use Sockso's {link url={ action="encoders" } text="encoders" }
