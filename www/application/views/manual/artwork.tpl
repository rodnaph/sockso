...
{include file="include/header.tpl" title="Artwork"}
...
what these files should be called by using {link url={ action="properties" } text="properties"})</p>
...
improve performance if you need it) then set the {link url={ action="properties" } text="property"}
